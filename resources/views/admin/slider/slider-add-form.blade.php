                                ...
                                <td>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="silde_image" id="slideImage" onchange="showImage(this, 'slide_show')" required>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('silde_title') is-invalid @enderror" name="silde_title" value="{{ old('silde_title') }}" id="slideTitle" placeholder="Write slide title here" required>
                                            @error('silde_title')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('silde_description') is-invalid @enderror" name="silde_description" id="slideDescription" placeholder="Write slide description here" value="{{ old('silde_description') }}" required>
