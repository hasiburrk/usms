...
<section class="container">
    <div class="row content">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <h4 class="text-center font-weight-bold font-italic mt-3">Faculty Edit Form</h4>
            </div>
        </div>
    ...
    <tr>
        <td>
            <div class="form-group row mb-0">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control @error('faculty_name') is-invalid @enderror" name="faculty_name" value="{{ $faculty->faculty_name }}" id="facultyName" placeholder="Write Faculty Name here" required>
                    @error('faculty_name')
