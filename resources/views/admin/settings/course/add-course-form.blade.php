...
@section('main-content')<br/><br/>
 ...
 <section class="container">
    <div class="row content">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <h4 class="text-center font-weight-bold font-italic mt-3">Course Add Form</h4>
            </div>
        </div>
 ...
 <div class="table-responsive p-1">
    ...
    <tr>
        <td>
            <div class="form-group row mb-0">
                <label for="courseName" class="col-form-label col-sm-3 text-right">Course Title</label>
                <div class="col-sm-9">
