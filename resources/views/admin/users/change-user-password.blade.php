    ...
    <div class="row content registration-form">
        <div class="col-12 pl-0 pr-0">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <h4 class="text-center font-weight-bold font-italic mt-3">User Password Change Form</h4>
                </div>
            </div>
        <form method="POST" action="{{ route('user-password-update') }}" enctype="multipart/form-data" autocomplete="" class="form-inline">
           @csrf
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="password" type="password" class="col-sm-9 form-control  @error('password') is-invalid @enderror" name="password" placeholder=" Old Password" required autofocus>
                    @error('password')
